...
namespace Proyecto_ED22.Helpers
{
    public class Data
    {
        ...
        public ArbolAVL<PacienteModel> ArbolAVL_DPIPacientes = new ArbolAVL<PacienteModel>((PacienteModel paciente1, PacienteModel paciente2) => paciente1.DPI - paciente2.DPI, (string unDPI, PacienteModel unPaciente) => Convert.ToInt32(unDPI) - unPaciente.DPI);
    }
}
