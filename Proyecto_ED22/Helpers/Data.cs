...
namespace Proyecto_ED22.Helpers
{
    public class Data
    {
        ...
        public ArbolAVL<PacienteModel> ArbolAVL_LimpiezaDental = new ArbolAVL<PacienteModel>((PacienteModel paciente1, PacienteModel paciente2) => paciente1.DPI.CompareTo(paciente2.DPI) , (string unNombre, PacienteModel unPaciente) => unNombre.CompareTo(unPaciente.DPI));
    }
}
